# AGENTS.md — CoursesTools backend Entry Shim (non-Claude agents)
...
This file is the auto-loaded shim for Codex / Cursor / any non-Claude agent (Claude reads `CLAUDE.md`; the substance is identical). Both point at the same router.
...
<!-- Keep identical in substance to CLAUDE.md. Full reasoning: llm-corner/docs/conventions/mindset.md. -->

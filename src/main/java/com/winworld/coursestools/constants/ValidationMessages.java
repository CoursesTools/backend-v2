package com.winworld.coursestools.constants;

public class ValidationMessages {
    public static final String NOT_NULL_MESSAGE = "The field must not be null";
    public static final String POSITIVE_MESSAGE = "The field must be positive";
